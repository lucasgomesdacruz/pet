...
import {ChevronLeft, ChevronRight, Syringe, CarTaxiFront, Hotel, Scissors, Clock } from "lucide-react"
                                ...
                                {services.map((item, index) => (
                                    <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                        <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                            ...
                                            <div className="border-t borde-gray- pt-4 flex items-center justify-between">
                                                ...
                                                <a 
                                                    href={`https://wa.me/5521992117045?text=Olá vim pelo site e gostaria de mais informações sobre ${item.title}`}
                                                    target="_blank"
                                                    className="flex items-center justify-center gap-2 hover:bg-[#009CA6] px-4 py-1 rounded-md duration-300"
                                                >
